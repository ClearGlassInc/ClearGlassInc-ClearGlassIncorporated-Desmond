...
const css = `.artemis-core{margin-top:54px;text-align:center;display:flex;flex-direction:column;align-items:center;pointer-events:none;animation:fadeUp 1s ease .52s both}.artemis-emblem{width:62px;height:62px;border-radius:50%;border:2px solid rgba(23, 21, 21,.24);display:flex;align-items:center;justify-content:center;font-size:34px;color:#e0dede;background:rgba(14, 14, 14,.58);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);animation:artemisFloat 4.8s ease-in-out infinite,artemisPulse 3.2s ease-in-out infinite}.artemis-title{margin-top:22px;font-family:var(--serif);font-size:48px;line-height:1;color:#e5e5ee;letter-spacing:-.04em}.artemis-title span{font-size:26px;color:#f0a9b4;letter-spacing:.04em}.artemis-subtitle{margin-top:16px;font-family:var(--mono);font-size:18px;letter-spacing:.18em;color:#b1a2a3}@keyframes artemisFloat{0%,100%{transform:translateY(0) rotate(0deg)}50%{transform:translateY(-9px) rotate(3deg)}}@keyframes artemisPulse{0%,100%{box-shadow:0 0 0 rgba(190, 170, 171,0)}50%{box-shadow:0 0 34px rgba(190, 170, 171,.34)}}`;
