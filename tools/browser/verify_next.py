...
with sync_playwright() as p:
    ...
    pg.locator("#cgm-constellation-h").scroll_into_view_if_needed(); pg.wait_for_timeout(900)
    n = pg.locator(".cgm-node")
    n.nth(0).click(force=True); n.nth(1).click(force=True); pg.wait_for_timeout(300)
    ...
    pg = ctx.new_page(); pg.goto(URL, wait_until="load"); pg.wait_for_timeout(400)
