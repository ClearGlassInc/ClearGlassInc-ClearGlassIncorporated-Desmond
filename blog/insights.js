...
(function () {
  ...
  if (page === 'hub') {
    var deskScript = document.createElement('script');
    deskScript.src = 'desk-cards.js';
    deskScript.onload = function () { initHub(); };
    deskScript.onerror = function () { initHub(); };
    document.body.appendChild(deskScript);
  }
