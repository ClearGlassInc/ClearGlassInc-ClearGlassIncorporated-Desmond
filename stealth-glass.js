...
(function () {
  ...
  var CSS = [
    "#cg-neon-aura{position:fixed;inset:0;z-index:2147483000;pointer-events:none;will-change:opacity;box-shadow:inset 0 0 130px rgba(238, 99, 101,.10),inset 0 0 46px rgba(238, 99, 122,.08);animation:cgNeonAura 6s ease-in-out infinite}",
    "#cg-neon-aura::after{content:'';position:absolute;right:-46px;bottom:-46px;width:340px;height:340px;border-radius:50%;background:radial-gradient(circle,rgba(238, 99, 101,.16),rgba(238, 99, 122,.09) 46%,transparent 72%);filter:blur(6px)}",
    "@keyframes cgNeonAura{0%,100%{opacity:.65}50%{opacity:1}}",
    "[data-skin='stealth'] #cg-neon-aura{box-shadow:inset 0 0 150px rgba(120,224,200,.12),inset 0 0 50px rgba(238, 99, 101,.08)}",
    "[data-skin='stealth'] #cg-neon-aura::after{background:radial-gradient(circle,rgba(120,224,200,.18),rgba(238, 99, 101,.08) 46%,transparent 72%)}",
    ...
    "#cg-stealth-btn:hover{color:#fff;transform:translate3d(var(--cg-mx),calc(var(--cg-my) - 1.5px),0) scale(1.035);box-shadow:0 8px 26px rgba(0,0,0,.46),0 0 0 .5px rgba(238, 99, 108,.5),0 0 22px -2px rgba(238, 99, 108,.5),inset 0 1px 0 rgba(255,255,255,.2),inset 0 -1px 0 rgba(0,0,0,.28)}",
    "#cg-stealth-btn:active{transform:translate3d(var(--cg-mx),var(--cg-my),0) scale(.975)}",
    "#cg-stealth-btn:focus-visible{outline:2px solid #ee636c;outline-offset:3px}",
    "#cg-stealth-btn .cg-sg-ic{width:13px;height:13px;display:block;flex:0 0 auto;position:relative;z-index:2;filter:drop-shadow(0 0 4px rgba(238, 99, 108,.45))}",
    "#cg-stealth-btn .cg-sg-ic svg{width:100%;height:100%;display:block}",
    "#cg-stealth-btn .cg-sg-tx{position:relative;z-index:2}",
    "#cg-stealth-btn .cg-sg-glow{position:absolute;inset:0;border-radius:inherit;z-index:0;pointer-events:none;background:radial-gradient(60% 120% at 18% 50%,rgba(238, 99, 108,.24),transparent 70%);opacity:.55;animation:cgSgPulse 4.2s ease-in-out infinite}",
    "@keyframes cgSgPulse{0%,100%{opacity:.4}50%{opacity:.86}}",
    "#cg-stealth-btn.is-on{color:#c9fbf2;background:linear-gradient(165deg,rgba(21, 15, 15,.62),rgba(4,14,14,.68));box-shadow:0 4px 18px rgba(0,0,0,.5),0 0 0 .5px rgba(120,224,200,.5),0 0 20px -3px rgba(120,224,200,.5),inset 0 1px 0 rgba(190,255,240,.16),inset 0 -1px 0 rgba(0,0,0,.3)}",
    ...
    "@supports not ((backdrop-filter:blur(1px)) or (-webkit-backdrop-filter:blur(1px))){#cg-stealth-btn{background:linear-gradient(165deg,rgba(43, 35, 35,.96),rgba(19, 15, 15,.97))}#cg-stealth-veil{background:rgba(6,9,13,.5)}}"
  ].join("");
