...
- Local MSPs/cybersecurity firms are not first-wave prospects because they overlap directly with ClearGlass's service category. Examples researched: Dataforge Canada, RTC Managed Services, Joe Apps Technology Support, IT Force, RieVax, BALANCED+, Fusion Computing.

## Sales sequence

1. Verify decision-maker and publicly available business contact channel.
2. Determine whether a relevant commercial message can lawfully be sent under CASL.
3. Personalize around one observable business risk; do not claim an unverified vulnerability.
4. Offer the CAD $249 Security Quick-Audit only where there is a plausible fit.
5. Record contact, response, meeting, proposal, payment and delivery evidence.
6. No prospect becomes a customer in the scorecard until payment or signed engagement is actually verified.

## Daily revenue target

- 10 qualified prospect research actions
- 5 compliant direct sales conversations where consent/legal basis exists
- 1 booked discovery conversation target
- 1 paid Quick-Audit target
- Every outcome recorded with evidence

## Evidence rule

No invented contacts, vulnerabilities, customers, meetings, payments, revenue, testimonials or case studies. Unknown = NOT VERIFIED.
